...
<html>
  <head>
    ...
    <!-- Gritter -->
    <link href="./style/blog/js/plugins/gritter/jquery.gritter.css" rel="stylesheet">
...
<body>
                                            ...
                                            <div class="feed-activity-list">
                                                ...
                                                <div class="feed-element">
                                                    <a href="profile.html" class="pull-left">
                                                        <img alt="image" class="img-circle" src="./style/blog/img/profile.jpg">
                                                    </a>
                                                ...
                                                <div class="feed-element">
                                                    <a href="profile.html" class="pull-left">
                                                        <img alt="image" class="img-circle" src="./style/blog/img/a3.jpg">
                                                    </a>
                                                    <div class="media-body ">
                                                        <small class="pull-right">2h ago</small>
                                                ...
                                                <div class="feed-element">
                                                    <a href="profile.html" class="pull-left">
                                                        <img alt="image" class="img-circle" src="./style/blog/img/a4.jpg">
                                                    </a>
                                                    <div class="media-body ">
                                                ...
                                                <div class="feed-element">
                                                    <a href="profile.html" class="pull-left">
                                                        <img alt="image" class="img-circle" src="./style/blog/img/a5.jpg">
                                                    </a>
                                                    <div class="media-body ">
                                                        <small class="pull-right">2h ago</small>
                                                ...
                                                <div class="feed-element">
                                                    <a href="profile.html" class="pull-left">
                                                        <img alt="image" class="img-circle" src="./style/blog/img/a7.jpg">
                                                    </a>
                                                    <div class="media-body ">
                    ...
                    <div id="tab-1" class="tab-pane active">
                        ...
                        <div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="./style/blog/img/a1.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="./style/blog/img/a2.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="./style/blog/img/a3.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="./style/blog/img/a4.jpg">
                                    </div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="./style/blog/img/a8.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="./style/blog/img/a7.jpg">
                                    </div>
                                    <div class="media-body">
    ...
    <script src="./style/blog/js/plugins/flot/jquery.flot.spline.js"></script>
    <script src="./style/blog/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="./style/blog/js/plugins/flot/jquery.flot.pie.js"></script>
    ...
    <!-- jQuery UI -->
    <script src="./style/blog/js/plugins/jquery-ui/jquery-ui.min.js"></script>

    <!-- GITTER -->
    <script src="./style/blog/js/plugins/gritter/jquery.gritter.min.js"></script>

    <!-- Sparkline -->
    <script src="./style/blog/js/plugins/sparkline/jquery.sparkline.min.js"></script>

    <!-- Sparkline demo data  -->
    <script src="./style/blog/js/demo/sparkline-demo.js"></script>

    <!-- ChartJS-->
    <script src="./style/blog/js/plugins/chartJs/Chart.min.js"></script>

    <!-- Toastr -->
    <script src="./style/blog/js/plugins/toastr/toastr.min.js"></script>
